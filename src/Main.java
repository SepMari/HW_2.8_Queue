...
public class Main {
        ...
        private static final List<String> NAMES = List.of("Иван", "Петр", "Илья", "Анна", "Ксения");
        ...
        public static void main (String[]args){
            ...
            System.out.println("Очередь на первую кассу: " + queue1);
            System.out.println("Очередь на вторую кассу: " + queue2);

            add("Крис", queue1, queue2);
            System.out.println("Очередь на первую кассу: " + queue1);
            System.out.println("Очередь на вторую кассу: " + queue2);
        ...
        static void randomFilling (Queue < String > queue) {
